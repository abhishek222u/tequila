...
const Header = () => {
  ...
  return (
    <header className="absolute top-0 bg-[var(--background)] w-full z-50 text-[var(--foreground)]">
          ...
          <div className="flex justify-between items-center gap-[15px]">
            ...
            <Link href={'#'}>
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="cursor-pointer group transform-gpu will-change-transform transition-all duration-600 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] hover:scale-110 hover:-translate-y-1 hover:rotate-1 hover:shadow-[0_15px_35px_rgba(255,255,255,0.25),0_5px_15px_rgba(0,0,0,0.1)] active:scale-95 active:translate-y-0 active:shadow-[0_8px_25px_rgba(255,255,255,0.2),0_3px_10px_rgba(0,0,0,0.1)]"
              >
                                  <circle 
                    cx="17" 
                    cy="17" 
                    r="16.5" 
                    className="stroke-[var(--foreground)] transition-all duration-600 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] group-hover:stroke-black group-hover:fill-white group-active:stroke-gray-800 group-active:fill-gray-100" 
                  />
                <mask
                  id="mask0_2020_2"
                ...
                >
                  <path
                    ...
                    className="fill-[var(--foreground)] transition-all duration-600 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] group-hover:fill-black group-hover:bg-white group-active:fill-gray-800 group-active:bg-gray-100"
                  />
                </mask>
              ...
              {[
                ...
                <div key={idx} className="w-4/12 sub-col">
                  <p className="tq__FoundersGrotesk_14 mb-[24px] uppercase relative z-1 after:content-[''] after:absolute after:left-0 after:top-0 after:h-[1px] after:w-full after:bg-[var(--foreground)] after:translate-y-[6px] after:-z-1">
                    <span className="bg-[var(--background)] pr-2">{col.tag}</span>
                  </p>
      ...
      {activeMenu && <div className="header-blur-background"></div>}
    </header>
  )
}

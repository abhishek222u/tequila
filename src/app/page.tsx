  ...
  return (
    <>
      <main>
        ...
        <section className="py-[150px] relative z-1 bg-[var(--background)]">
          <div className="container flex justify-between m-auto">
        ...
        <section className="py-[150px] relative z-1">
          <div className="container m-auto">
            ...
            <HeroTextLine text="What We Do" className="tq__PPBook__100 block text-3xl !text-white" delay={0} index={5} />
            <h3 className="tq__Instrument_36 mb-[64px]">
              <HeroTextLine text="Our services are wrapped" className="block !text-white" delay={0} index={9} />
              <HeroTextLine text="around our story, what we stand for!" className="block !text-white" delay={0.2} index={10} />
            </h3>
            <div className="flex justify-between gap-[24px]">
              <ScrollReveal delay={0.2} className="w-full min-h-[680px]">
                <div className="tq__FoundersGrotesk_14 uppercase relative after:content-[''] after:absolute after:top-0 after:right-0 after:w-[85%] after:h-full after:bg-white !text-white">
                  Technology
                </div>
                <div className="p-8 h-[270px] bg-white">
                  <h3 className="tq__PPMedium__58 !text-black mb-[16px]">
                    Web Design & Development
                  </h3>
                  <p className="tq__FoundersGrotesk_22 font-light !text-black">
                ...
                <div className="transparent-buttons-block relative ">
                  ...
                  <div className="all-buttons-texts">
                    <div className="rowFirts-div !mt-2">
                      <a href="" className="buttons1 row1button1 ml-3.5 !text-white">Custom Website Design & Development</a>
                      <a href="" className="buttons1 row1button2 !ml-18 !text-white">Domain & Hosting Management</a>
                    </div>
                    <div className="rowFirts2-div !mt-4.5">
                      <a href="" className="buttons1 row2button2 ml-3.5 !text-white">Ecommerce Website Design &
                        Development</a>
                    </div>
                    <div className="rowFirts3-div !mt-5">
                      <a href="" className="buttons1 row2button2 ml-3.5 !text-white">Website Maintenance & Support</a>
                      <a href="" className="buttons1 row2button2 ml-24 !text-white">Web Applications Design &
                        Development</a>
                    </div>
                  </div>
                </div>
              ...
              <ScrollReveal delay={0.3} className="w-full min-h-[680px]">
                <div className="tq__FoundersGrotesk_14 uppercase relative after:content-[''] after:absolute after:top-0 after:right-0 after:w-[80%] after:h-full after:bg-white !text-white">
                  Identity & Design
                </div>
                <div className="p-8 h-[252px] bg-white">
                  <h3 className="tq__PPMedium__58 text-black mb-[16px]">Branding</h3>
                  <p className="tq__FoundersGrotesk_22 font-light text-black mb-[32px]">
                ...
                <div className="transparent-buttons-block Branding">
                  ...
                  <div className="all-buttons-texts">
                    <div className="rowFirts-div Branding">
                      <a href="" className="buttons1 row1button1 Branding ml-4 !text-white">Logo Design & Visual Identity</a>
                      <a href="" className="buttons1 row1button2 Branding !text-white">Branding, Strategy & Development</a>
                    </div>
                    <div className="rowFirts2-div Branding">
                      <a href="" className="buttons1 row2button85 Branding ml-4 !text-white">Rebranding</a>
                      <a href="" className="buttons1 row2button5 Branding !text-white">Brand Elevation</a>
                      <a href="" className="buttons1 row2button6 Branding 2xl:ml-8 !text-white">UI/ UX Design for Digital Products</a>
                    </div>
                    <div className="rowFirts3-div !mt-5">
                      <a href="" className="buttons1 row2button52 Branding ml-4 !text-white">Corporate Profile & Company Brochure</a>
                      <a href="" className="buttons1 row2button366 Branding 2xl:ml-20 !text-white">Graphic Design</a>
                    </div>
                  </div>
                </div>
              ...
              <ScrollReveal delay={0.4} className="w-full min-h-[680px]">
                <div className="tq__FoundersGrotesk_14 uppercase relative after:content-[''] after:absolute after:top-0 after:right-0 after:w-[76%] after:h-full after:bg-white !text-white">
                  Visual Storytelling
                </div>
                <div className="p-6 h-[310px] bg-white">
                  <h3 className="tq__PPMedium__58 text-black mb-[16px]">
                    Communication
                  </h3>
                  <p className="tq__FoundersGrotesk_22 font-light text-black mb-[32px]">
                ...
                <div className="transparent-buttons-block Branding Communication">
                  ...
                  <div className="all-buttons-texts">
                    <div className="rowFirts-div Branding Communication">
                      <a href="" className="buttons1 row1button1 Branding Communication ml-6 !text-white">Video Storyboarding & Production</a>
                      <a href="" className="buttons1 row1button2 Branding Communication !text-white">Photography & Visual Storytelling</a>
                    </div>
                    <div className="rowFirts2-div Branding Communication">
                      <a href="" className="buttons1 row2button85 Branding Communication ml-6 !text-white">Social Media Strategy & Design</a>
                      <a href="" className="buttons1 row2button5 Branding Communication !text-white">Search Engine Optimisation(SEO)</a>
                    </div>
                  </div>
                </div>
                <svg
                ...
                return (
                  <div className="space-y-0">
                    {faqData.map((faq, index) => (
                                      <div key={index} className="border-b-[0.5px] border-[var(--foreground)]">
                  <div
                    className="pt-[20px] pb-[14px] flex justify-between items-center gap-[32px] cursor-pointer group"
                    style={{
                      transition: 'all 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94)',
                      color: openFaq === index ? 'var(--background)' : 'inherit',
                      ...
                      if (openFaq !== index) {
                        ...
                        >
                          ...
                          <svg
                            ...
                            style={{
                              ...
                              stroke: openFaq === index ? 'var(--background)' : 'var(--foreground)',
                        ...
                        >
                          <div className="pb-[20px] pl-[32px] pr-[32px]">
                            <p className="tq__FoundersGrotesk_16 text-[var(--foreground)] leading-relaxed">
                              {faq.answer}
                            </p>
                          </div>
                        </div>
            ...
            <div className="flex justify-between gap-[32px]">
              <div className="w-full">
                ...
                <ScrollReveal delay={0.3} className='relative'>
                  <div className='bg-[var(--background)] absolute top-0 left-0 text-[var(--foreground)] z-50 px-2 uppercase'>
                  branding, business
                  </div>
                  <Image
                    src={insights1}
        ...
        <section className="w-screen h-[80vh] mt-[250px]">
          ...
          <div className="relative w-screen h-24 overflow-hidden bg-yellow-500 transform -skew-y-8 py-6 -my-16">
